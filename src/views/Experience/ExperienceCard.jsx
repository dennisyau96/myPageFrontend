...
function ExperienceCard({ content }) {
  ...
  return (
    <div className="p-4 m-5 border-2 rounded-lg bg-white z-0 max-w-md min-w-96 hover:shadow-xl hover:shadow-gray-300 hover:transition-all hover:duration-300">
      {content.position ? (
