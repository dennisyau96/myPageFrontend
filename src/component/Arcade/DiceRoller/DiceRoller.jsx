...
function DiceRoller() {
  ...
  return (
    <div className=" border-gray-600 border-1 rounded-md px-2 py-3 max-w-96 duration-300 hover:transition-all ease-in-out hover:shadow-lg hover:shadow-sky-300 bg-opacity-90">
