...
function Counter() {
  ...
  return (
    <div className="border-1 border-gray-600 rounded-md px-4 py-3 max-w-96 duration-200 hover:transition-all hover:shadow-lg hover:shadow-sky-300 bg-opacity-90">
